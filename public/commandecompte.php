...
<!-- navbar -->
    ...
    <!--  -->
    <div class="container">
        <div class="side-command">
            <div class="row" >
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-4 mb-4">
                    <div class="side-command__menu">
                        <ul>
                            <li class="side-command__menu--active">
                                <a href="commandecompte.html">Votre compte ILB</a>
                            </li>
                            <li>
                                <a href="commandeliste.html">Vos commandes</a>
                            </li>
                            <li>
                                <a href="commandeadresse.html">Adresse</a>
                            </li>
                            <li>
                                <a href="commandemdp.html">Modifier mot de passe</a>
                            </li>
                            <li>
                                <a href="commandeinfoperso.html">Informations personnelles</a>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-8" >
                        <!-- active contenu -->
                    <div class="side-command__contenu ">
                        <div class="side-command__contenu--title">
                            <h3>Votre Compte</h3>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                                <div class="card-contenu">
                                    <div class="card-contenu__title">
                                        <h3>Informations personnelles</h3>
                                        <a href="commandemdp.html">
                                            <div class="write">
                                    ...
                                    <div class="card-contenu__text">
                                        <h3 class="user--name "> <?php
                                                echo  $_SESSION['nom'];
                                            ?>

                                        </h3>
                                        <span class="user--email">  <?php
                                   ...
                                   <a href="commandemdp.html">
                                        <div class="card-contenu__button">
